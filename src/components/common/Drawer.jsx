  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center md:bg-[#ffffff2c] text-yellow-500 text-2xl top-4.5 md:top-9 right-90 md:right-12 z-30 cursor-pointer hover:bg-yellow-200 hover:text-black transition-all "
      >
        <IoSettingsSharp />
      </div>
